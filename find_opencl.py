...
def find_opencl_include_dir():
    ...
    suffix = ["include", "OpenCL/common/inc", "AMD APP/include", "C:\Program Files (x86)\Intel\oneAPI\compiler\\2024.0\include\sycl"]
...
def find_opencl_library_dir():
    ...
    if platform.architecture()[0] == "32bit":
        suffix = ["AMD APP/lib/x86", "lib/x86", "lib/Win32", "OpenCL/common/lib/Win32",  "C:\Program Files (x86)\Intel\oneAPI\compiler\\2024.0\lib"]
    elif platform.architecture()[0] == "64bit":
        suffix = ["AMD APP/lib/x86_64", "lib/x86_64", "lib/x64", "OpenCL/common/lib/x64",  "C:\Program Files (x86)\Intel\oneAPI\compiler\\2024.0\lib"]
