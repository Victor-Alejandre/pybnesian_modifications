...
std::shared_ptr<Factor> CKDEType::new_factor_wbm(const BayesianNetworkBase& m,
                                             const std::string& variable,
                                             const std::vector<std::string>& evidence,
    ...
    return generic_new_factor_ckde<CKDE>(variable, evidence, m_bselector, args, kwargs);
}
