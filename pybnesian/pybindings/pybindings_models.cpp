...
public:
    ...
    void fit_wbm(const DataFrame& df, const std::shared_ptr<BandwidthSelector> m_bselector, const Arguments& construction_args =  Arguments()) override {
        PYBIND11_OVERRIDE_PURE(void, Base, fit_wbm, df, m_bselector,construction_args);
    }
...
:param construction_args: Additional arguments provided to construct the :class:`Factor <pybnesian.Factor>`.
        ...
        .def("fit_wbm", &CppClass::fit_wbm, py::arg("df"), py::arg("m_bselector"), py::arg("construction_args") = Arguments(), R"doc(
...
:param m_bselector: BandwidthSelector to fit the CKDE nodes
:param construction_args: Additional arguments provided to construct the :class:`Factor <pybnesian.Factor>`.
)doc")
        .def("logl",
             &CppClass::logl,
