...
using kde::BandwidthSelector, kde::NormalReferenceRule;
...

    {
        ...
        hc.def("estimate",
            ...
            .def("estimate",
                 ...
                 py::arg("verbose") = 0)
                .def("estimate_wbm",
                 &GreedyHillClimbing::estimate_wbm<BayesianNetworkBase>,
                 py::arg("operators"),
                 py::arg("score"),
                 py::arg("start"),
                 py::arg("arc_blacklist") = ArcStringVector(),
                 ...
                 py::arg("epsilon") = 0,
                 py::arg("patience") = 0,
                 py::arg("m_bselector") = std::make_shared<NormalReferenceRule>(),
                 py::arg("verbose") = 0,
                 R"doc(
