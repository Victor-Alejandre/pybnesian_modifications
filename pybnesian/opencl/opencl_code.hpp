...
namespace opencl {
    const std::string OPENCL_CODE = R"foo(
...
R"foo(        __private uint mat_offset,
...
__kernel void scv_1d_double(__global double *restrict data,
                             ...
                             __private double log_ga)foo"
R"foo(ussian_const_h_2g,
...
__kernel void substract_float(__global float *restrict training_matrix,
    ...
    res[i] = test_matrix[IDX(test_offset + test_row_idx, c, test_physical_rows)] -)foo"
R"foo( training_matrix[IDX(r, c, training_physical_rows)];
}
...
__kernel void eta_1_float(__global float *restrict diff_matrix,
                        __priva)foo"
R"foo(te uint diff_matrix_rows, 
                        __private uint matrices_cols,
