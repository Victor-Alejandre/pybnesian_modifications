...
struct OpenCL_kernel_traits<arrow::DoubleType> {
    ...
    inline constexpr static const char* eta_1 = "eta_1_double";
    inline constexpr static const char* gaussian_density = "gaussian_density_double";
    inline constexpr static const char* complete_higher_derivate = "complete_higher_derivate_double";
    inline constexpr static const char* sum_bcv_mat = "sum_bcv_mat_double";
...
struct OpenCL_kernel_traits<arrow::FloatType> {
    ...
    inline constexpr static const char* eta_1 = "eta_1_float";
    inline constexpr static const char* gaussian_density = "gaussian_density_float";
    inline constexpr static const char* complete_higher_derivate = "complete_higher_derivate_float";
    inline constexpr static const char* sum_bcv_mat = "sum_bcv_mat_float";
