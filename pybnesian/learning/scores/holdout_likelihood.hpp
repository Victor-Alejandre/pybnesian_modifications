...
private:
    ...
    //double factor_score_wbm(const std::string& variable, const std::vector<std::string>& evidence, const std::shared_ptr<BandwidthSelector> m_bselector) const;
...
// Cambiar para validated con selector poner otro parámetro de factortype 
