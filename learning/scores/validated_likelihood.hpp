...
public:
    ...
    double local_score_wbm(const BayesianNetworkBase& model,
                               ...
                               const std::string& variable,
                               const std::vector<std::string>& parents) const override {
        return m_cv.local_score_wbm(model, m_bselector, variable, parents);                        
    }
    ...
    double local_score_wbm(const BayesianNetworkBase& model,
                               ...
                               const std::string& variable,
                               const std::vector<std::string>& parents) const override {
        return m_cv.local_score_wbm(model, variable_type, m_bselector, variable, parents);
    }
    ...
    double vlocal_score_wbm(const BayesianNetworkBase& model,
                               ...
                               const std::string& variable,
                               const std::vector<std::string>& parents) const override {
        return m_holdout.local_score_wbm(model, m_bselector, variable, parents);
    }
    ...
    double vlocal_score_wbm(const BayesianNetworkBase& model,
                               ...
                               const std::string& variable,
                               const std::vector<std::string>& parents) const override {
        return m_holdout.local_score_wbm(model, variable_type, m_bselector, variable, parents);
    }
